...
{
	show_message("O campo username deve conter no minimo 3 caracteres");
	exit;
}
...
if(string_length(password) < 5)
{
	show_message("O campo password deve conter no minimo 5 caracteres");
	exit;
}
